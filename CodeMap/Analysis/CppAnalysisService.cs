...
public sealed class CppAnalysisService
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        while (pendingDocuments.Count > 0 && parsedDocuments.Count < MaxParsedCppDocuments)
        {
            ...
            string[] codeLines = StripCommentsAndStrings(rawLines);
            string[] rawLinesWithoutComments = StripCommentsPreservingStrings(rawLines);
    ...
    private static string[] StripCommentsAndStrings(IReadOnlyList<string> rawLines)
    {
    ...
    private static string[] StripCommentsPreservingStrings(IReadOnlyList<string> rawLines)
    {
        bool inBlockComment = false;
        string[] strippedLines = new string[rawLines.Count];
